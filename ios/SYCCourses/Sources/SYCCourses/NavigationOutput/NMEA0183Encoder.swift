...
enum NMEA0183Encoder {
    ...
    private static func bwcFields(for waypoint: NavigationWaypointState) -> [String] {
        ...
        let magneticBearing = waypoint.magneticVariationDegrees.map {
            NavigationMath.magneticBearing(trueBearing: waypoint.bearingTrue, variationDegrees: $0)
        }
        return [
            "GPBWC",
            ...
            "T",
            magneticBearing.map(formatBearing) ?? "",
            "M",
